<x-app-layout>
    <x-slot name="header">Générer un hook</x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-2xl p-8">
            ...
            <div class="mb-8">
                <h3 class="text-xl font-bold text-white">Générer un hook</h3>
                <p class="text-gray-400 text-sm mt-1">
                    Un hook accrocheur pour capter l'attention dès la première ligne.
                </p>
            </div>

            <form method="POST" action="{{ route('posts.storeHook') }}" class="space-y-6">
                @csrf

                {{-- Sujet --}}
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">
                        Sujet <span class="text-violet-400">*</span>
                    </label>
                    <input type="text" name="sujet" id="sujet-input"
                           value="{{ old('sujet') }}"
                           maxlength="255"
                           placeholder="Ex: Mon parcours de développeur autodidacte"
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">
                        Ton <span class="text-violet-400">*</span>
                    </label>
                    <select name="ton"
                            class="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700
                ...
                <div>
                    ...
                    <input type="text" name="audience"
                           value="{{ old('audience') }}"
                           placeholder="Ex: Freelances, entrepreneurs"
                           class="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700
                                  text-white placeholder-gray-500 focus:outline-none focus:border-violet-500
                                  focus:ring-1 focus:ring-violet-500 transition text-sm"/>
                    @error('audience')
                ...
                <button type="submit" id="submit-btn"
                    ...
                    <span id="btn-text">Générer mes hooks</span>
